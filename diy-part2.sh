...
#sed -i 's/mediatek/0ff/g' feeds/luci/applications/luci-app-turboacc/luasrc/model/cbi/turboacc.lua
#sed -i 's/mt7915e.ko/0ff/g' feeds/luci/applications/luci-app-turboacc/luasrc/model/cbi/turboacc.lua
